...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      this.client = new _client2.default(this.props.config.github);
	    }
	  }, {
	    ...
	    key: 'listPosts',
	    value: function listPosts() {
	      var _this2 = this;

	      var res = this.client.listPosts();
	      res.then(function (posts) {
	        _this2.setState({ error: false, loading: false, posts: posts });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var props = Object.assign({}, this.state, { config: this.props.config });
	      return _react2.default.createElement(
	        'div',
	        { className: 'mill-app' },
	        _react2.default.cloneElement(this.props.children, props)
	      );
	    }
	  }]);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/post/:id', component: _detail2.default })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var qs = __webpack_require__(212);
	...
	var convertPost = function convertPost(post) {
	  return {
	    id: post.id,
	    number: post.number,
	    html: post.body_html,
	...
	Client.prototype.listPosts = function (args) {
	  var url = this.getUrl('/repos/' + this.owner + '/' + this.repo + '/issues');
	  return this.request(url, args).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Stringify = __webpack_require__(213);
	const Parse = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Utils = __webpack_require__(214);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.posts.map(function (post, i) {
	            return _react2.default.createElement(ListItem, _extends({ key: post.id }, post));
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = (function (_React$Component) {
	  ...
	  function Detail(props) {
	    ...
	    var post = _this.fetchPost(props.params.id, props.posts);
	    _this.state = {
	      post: post
	    };
	    return _this;
	  ...
	  _createClass(Detail, [{
	    key: 'fetchPost',
	    value: function fetchPost(postId, posts) {
	      var post = {};
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      var post = this.fetchPost(nextProps.params.id, nextProps.posts);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'mill-detail-content' },
	          _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.post.html } })
	        )
	      );
	    }
	  }]);
